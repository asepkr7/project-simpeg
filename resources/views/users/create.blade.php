            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/users" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password"  required oninput="toggleShowPasswordButton('password')">
                            ...
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <input type="password" class="form-control @error('password') is-invalid @enderror" id="password_confirmation" name="password_confirmation"  required oninput="toggleShowPasswordButton('password_confirmation')">
