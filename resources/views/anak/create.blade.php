            ...
            <h6 class="text-center  mt-2">Edit Data Anak &nbsp;</h6>
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item">
                        <a href="/petugas/data-anak">Anak</a>
                    </div>
                    <div class="breadcrumb-item">
                        Create
                    </div>
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/data-anak" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group col-12 row">
                            ...
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <select name="status_anak" id="status_anak" class="form-control @error('status_anak') is-invalid @enderror">
                                        <option value="">Pilih Status Anak</option>
                                        <option value="Anak Kandung" {{ old('status_anak') == 'Anak Kandung' ? 'selected' : '' }}>Anak Kandung</option>
                                        <option value="Anak Tiri" {{ old('status_anak') == 'Anak Tiri' ? 'selected' : '' }}>Anak Tiri</option>
                                    </select>
                                     @error('status_anak')
                                  <div class="invalid-feedback">
                                    {{ $message }}
