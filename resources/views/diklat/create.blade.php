            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/diklat" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control @error('diklat') is-invalid @enderror" name="diklat" id="diklat" value="{{ old('diklat')}}">
                                        @error('diklat')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control @error('jumlah_jam') is-invalid @enderror" name="jumlah_jam" id="jumlah_jam" value="{{ old('jumlah_jam')}}">
                                        @error('jumlah_jam')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group col-12 row">
                                    <div class="col-md-5 ml-1">
                                        ...
                                        <input type="text" class="form-control  @error('no_sttpp') is-invalid @enderror" name="no_sttpp" value="{{ old('no_sttpp') }}">
                                        @error('no_sttpp')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control  @error('tanggal_sttpp') is-invalid @enderror" name="tanggal_sttpp" id="tanggal_sttpp" value="{{ old('tanggal_sttpp') }}">
                                 @error('tanggal_sttpp')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
