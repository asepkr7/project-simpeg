            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/data-pasangan" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="form-group col-12 row">
                            ...
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <select name="status_pasangan" id="status_pasangan" class="custom-select @error('status_pasangan') is-invalid @enderror">
