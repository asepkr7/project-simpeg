            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/gapok/{{ $gapok->id }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            <div class="form-group">
                                <div class="col-md-9">
                                    ...
                                    <select name="pegawai_id" id="pegawai_id" class="form-control select2 select2-hidden-accessible @error('pegawai_id') is-invalid @enderror">
                                        ...
                                        @if ( old('pegawai_id', $gapok->pegawai_id) ==  $p->id)
                             ...
                             <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control @error('jumlah_gapok') is-invalid @enderror" name="jumlah_gapok" id="jumlah_gapok" value="{{ old('jumlah_gapok', $gapok->jumlah_gapok)}}">
                                        @error('jumlah_gapok')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                @enderror
                                 ...
                                 <div class="form-group col-12 row mt-3">
                                    <div class="col-md-5 ml-1">
                                        ...
                                        <input type="text" class="form-control  @error('no_sk') is-invalid @enderror" name="no_sk" value="{{ old('no_sk', $gapok->no_sk) }}">
                                        @error('no_sk')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" class="form-control  @error('tanggal_sk') is-invalid @enderror" name="tanggal_sk" id="tanggal_sk" value="{{ old('tanggal_sk', $gapok->tanggal_sk) }}">
                                 @error('tanggal_sk')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                             ...
                             <input type="text" class="form-control  @error('pejabat_sk') is-invalid @enderror" name="pejabat_sk" value="{{ old('pejabat_sk', $gapok->pejabat_sk)}}">
                               @error('pejabat_sk')
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                             ...
                             <input type="date" class="form-control  @error('tmt') is-invalid @enderror" name="tmt" value="{{ old('tmt', $gapok->tmt)}}">
                               @error('tmt')
                            <div class="invalid-feedback d-block">
                              {{ $message }}
                            </div>
