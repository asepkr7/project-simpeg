...
@section('container')
    <div class="section">
        <div class="section-header">
            ...
            <h6 class="text-center  mt-2">Create Data Riwayat{{ $title }} &nbsp;</h6>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item {{Request::is('petugas/dashboard')  ? 'active' : ''}}">
                        <a href="/petugas/dashboard">Dashboard</a>
                    </div>
                    <div class="breadcrumb-item {{Request::is('petugas/penghargaan')  ? 'active' : ''}}">
            ...
            <div class="section-body">
                <div class="card">
                    ...
                    <div class="card-body col-md-12">
                        <form action="/petugas/penghargaan" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control @error('penghargaan') is-invalid @enderror" name="penghargaan" id="penghargaan" value="{{ old('penghargaan')}}">
                                        @error('penghargaan')
                                        <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" class="form-control @error('tingkat_kegiatan') is-invalid @enderror" name="tingkat_kegiatan" id="tingkat_kegiatan" value="{{ old('tingkat_kegiatan')}}">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                             ...
                             <input type="text" class="form-control  @error('tahun_penghargaan') is-invalid @enderror" name="tahun_penghargaan" value="{{ old('tahun_penghargaan')}}">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                             ...
                             <input type="text" class="form-control  @error('no_sertifikat') is-invalid @enderror" name="no_sertifikat" value="{{ old('no_sertifikat')}}">
                               @error('no_sertifikat')
                            <div class="invalid-feedback d-block">
                              {{ $message }}
                            </div>
